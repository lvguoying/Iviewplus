...
export default {
  ...
  methods: {
    ...
    addProduce() {
      ...
      params.append(
        "produfactors_chem_price",
        this.formValidate.produceFertilizer
      );
      params.append(
        "produfactors_pesticide_price",
        this.formValidate.producePesticides
      );
      params.append("produfactors_sowing_price", this.formValidate.produceSow);
      params.append(
        "produfactors_rotary_price",
        this.formValidate.produceCultivation
      );
      params.append(
        "produfactors_spraying_price",
        this.formValidate.produceSpray
      );
      params.append(
        "produfactors_harvest_price",
        this.formValidate.produceHarvest
      );
      params.append(
        "produfactors_autusoil_price",
        this.formValidate.producePrepare
      );
      params.append(
        "produfactors_manmade_price",
        this.formValidate.producePerson
      );
      params.append(
        "produfactors_insurance_price",
        this.formValidate.produceInsurance
      );
      params.append(
        "produfactors_accrual_price",
        this.formValidate.produceInterest
      );
      params.append(
        "produfactors_plantcost_sum",
        this.formValidate.produceCost
      );
      ...
      params.append(
        "produfactors_plant_allowance",
        this.formValidate.producePlantSubsidy
      );
      params.append(
        "produfactors_grov_allowance",
        this.formValidate.producePolicySubsidy
      );
    ...
    getProduce() {
      ...
      params.append("produfactors_dept_id", sessionStorage.getItem("dept_id"));
      axios
        .get(global.API_PATH + "produfactors/produfactors_msg_sel", params)
        .then(response => {
          for (let i = 0; i < response.data.length; i++) {
            ...
            this.data1.push({
              ...
              producePesticides:
                response.data[i].w_produfactors_pesticide_price,
              ...
              producePlantSubsidy:
                response.data[i].w_produfactors_plant_allowance,
              producePolicySubsidy:
                response.data[i].w_produfactors_grov_allowance,
